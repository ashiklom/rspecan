...
- More on intra-specific trait variability
  - Variability in litter leachate chemistry by site and phenophase [@hudson_2018_american]
  - Variability in traits within a canopy, using leaf spectra [@gara_2018_impact]
...
- IS (airborne) to map foliar nitrogen. In particular, used PROSPECT RTM inversion [@wang_2018_mapping].
  - PROSPECT recalibration and inversion to estimate proteins [@wang_2015_applicability]
  - RTM inversion to estimate N from other traits [@wang_2015_leaf]
- Spectroscopy can be used to monitor plant stress
    - Maize plant response to drought [@sun_2018_reflectance]
- Detection of invasive species [@ewald_2018_analyzing]
