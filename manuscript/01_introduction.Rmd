...
Compared to alternative approaches for estimating leaf properties from spectra, including spectral indices [CITE] and partial least squares regression (PLSR), PROSPECT inversion offers the following advantages.
