...
leaf water content per area ($$g cm^{-2}$$),
and leaf dry matter content per area ($$g cm^{-2}$$).

[NOTE: Using g m-2 gives whole numbers for the last two traits -- should I do that?]
